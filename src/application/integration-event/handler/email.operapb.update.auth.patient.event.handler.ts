...
import { EmailOperaPBUpdateAuthPatientValidator } from '../../domain/validator/email.operapb.update.auth.patient.validator'
...
export class EmailOperaPBUpdateAuthPatientEventHandler implements IIntegrationEventHandler<EmailEvent> {
    /**
     * Creates an instance of EmailOperaPBUpdateAuthPatientEventHandler.
     *
